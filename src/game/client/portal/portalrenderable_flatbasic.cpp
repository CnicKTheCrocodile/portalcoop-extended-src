...
CLIENTEFFECT_MATERIAL( "models/portals/portalstaticoverlay_li1_1" )
...
public:
	...
	void LevelInitPreEntity()
	{
		...
		m_Materials.m_PortalStaticOverlay_li1[0].Init( "models/portals/portalstaticoverlay_li1_1", TEXTURE_GROUP_CLIENT_EFFECTS );
